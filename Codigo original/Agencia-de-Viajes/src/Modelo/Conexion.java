...
public class Conexion 
{
    ...
    private static String password = "123456";//Contraseña de la Base de Datos
    private static String url = "jdbc:oracle:thin:@//localhost:1521/xe";//url conexion a la base de Datos llamada "Proyecto"
